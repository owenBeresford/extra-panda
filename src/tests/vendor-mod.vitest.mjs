...
const {
	 apply_vendors, mod_parli, mod_codepen, mod_wikipedia, mod_mongodb, mod_caniuse, mod_graphQL, 
	mod_react, mod_GDN, mod_stackoverflow, mod_github, mod_medium, mod_scribe, mod_npmjs
 } = TEST_ONLY;

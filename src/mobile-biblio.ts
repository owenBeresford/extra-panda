 ...
 */
function normaliseData(data:Array<ReferenceType|null>):Array<NormalisedReference> {
	const po=[ 
		"[No author]",  
 ...
 * @return {void}
 */
async function createBiblio(opts:MobileBiblioProps, dom:Document=document, loc:Location=location):Promise<void> {

...
import * as javascript from "highlight.js/lib/languages/yaml";

// custom written loader as code is packed in a legacy fashion
hljs.registerLanguage("yaml", (hl: HLJSApi): Language => {
...
export function execHighlight(dom: Document = document): void {
  dom.querySelectorAll('code[lang="yaml"]').forEach((el: HTMLElement): void => {

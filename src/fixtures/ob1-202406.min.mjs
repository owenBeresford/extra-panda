...
function O(e2) {
  ...
  !function(e3, t3, n3) {
    if (null !== n3.querySelector("#" + t3)) throw new Error("CSS blob already exists, you have a logic error");
    const r2 = n3.createElement("style");
    r2.setAttribute("id", t3), r2.innerText = e3, n3.getElementsByTagName("head")[0].append(r2);
  }("body, .annoyingBody { font-family: " + n2.ft + "; font-size: " + n2.fs + "; direction:" + n2.dn + "; }", "client-set-css", e2);
}
...
function ae(e2) {
  const t2 = new RegExp("`([^`]+)`", "g"), n2 = new RegExp("/ /", "g");
  let r2;
  for (; r2 = e2.next() && r2 && false === r2.done; ) {
    let e3 = r2.value;

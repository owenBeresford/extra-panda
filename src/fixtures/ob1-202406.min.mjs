...
function k(e2, t2, n2) {
  ...
  try {
    ...
    if (r2.has("mobile")) return y(r2.get("mobile") ?? "");
    let t3 = u;
    return L(e2, n2.navigator, n2) && (t3 = 1.11 * u), q(e2, n2) > t3;
  } catch (e3) {
    return !(!r2.has("mobile") || !y(r2.get("mobile") ?? ""));
  }
}
function q(e2, t2) {
  try {
...
function C(e2, t2, n2) {
  if (null !== n2.querySelector("#" + t2)) throw new Error("CSS blob already exists, you have a logic error");
  const r2 = n2.createElement("style");
  r2.setAttribute("id", t2), r2.innerText = e2, n2.getElementsByTagName("head")[0].append(r2);
}
function x(e2, t2) {
  for (let r2 = 0; r2 < e2.childNodes.length; r2++) {
    var n2 = e2.childNodes[r2];
    n2.nodeType !== Node.TEXT_NODE && x(n2, t2), t2(n2, e2);
  }
}
function N(e2, t2) {
...
class M {
  static set(e2, t2, n2, r2) {
    let o2 = "";
    if (n2) {
      const e3 = /* @__PURE__ */ new Date();
      e3.setTime(e3.getTime() + 24 * n2 * 60 * 60 * 1e3), o2 = "expires=" + e3.toUTCString();
    }
    r2.cookie = e2 + "=" + t2 + "; " + o2 + "; path=/ ;secure";
  }
  static get(e2, t2) {
    const n2 = e2 + "=", r2 = decodeURIComponent(t2.cookie).split("; ");
    let o2 = "";
    return r2.forEach((e3) => {
      0 === e3.indexOf(n2) && (o2 = e3.substring(n2.length));
    }), o2;
  }
  static wipe(e2, t2) {
    const n2 = /* @__PURE__ */ new Date();
    n2.setTime(n2.getTime() + 288e5);
    const r2 = "expires=" + n2.toUTCString();
    t2.cookie = e2 + "= ; " + r2 + "; path=/ ;secure", t2.cookie = e2 + "= ; " + r2 + "; path=/ ";
  }
}
function O(e2, t2, n2, r2, o2 = document) {
  ...
  if (k(r2, o2, i2) && !a2) 1 === r2.querySelectorAll(".adjacentWidget .adjacentItem").length && (r2.querySelector(".adjacentWidget p").style.display = "none"), w("#" + s2, "<p>As mobile View, use the full page link to the left</p>", r2);
    ...
    if (a2) {
      const t3 = function(e3, t4, n2, r3, o3) {
        let i3 = "";
        for (const a3 in e3) {
          const s3 = P(a3, t4), l2 = k(n2, r3, o3) ? "<br />" : "";
          let c2 = e3[a3].desc;
      ...
      const t3 = function(e3) {
        ...
        for ([t4, n2, o3] = F(W(e3[0].url), U.name, e3.length, o3, t4); o3 < e3.length; o3++) {
          ...
          if (a3 && t4 >= 0 && n2 > 0) {
            r3[i3] = { auth: e3[o3].auth, date: b(e3[o3].date, "[Unknown time]", true), url: e3[o3].url, offset: o3, title: e3[o3].title.substr(0, U.titleLimit), desc: e3[o3].desc }, a3.length > U.titleLimit && (r3[i3].title += "...");
            const t5 = e3[o3].desc;
      ...
      w("#" + s2, function(e3, t4) {
        ...
        for (const r3 in e3) {
          const o3 = P(r3, t4), i3 = j(e3[r3].desc.length > 110), a3 = "Title: " + e3[r3].title + "\nAuthor: " + e3[r3].auth + " &nbsp; &nbsp; Last edit: " + e3[r3].date + "\nDescription: " + e3[r3].desc;
...
function $(e2, t2, r2, o2) {
  ...
  return t2.querySelector("#popup").close(), o2.open(a2, "_blank"), k(t2, r2, o2) && B(0, t2, r2, o2), false;
}
function J(e2, t2, n2) {
  ...
  }(r2, T, e2, t2, n2), Y(e2.querySelector("#popup #sendMasto"), $, e2, t2, n2);
  ...
  if (t2.querySelector(e2) && (n("info", "Keybaord events enabled for " + e2, r2.hash), t2.addEventListener("keydown", (n2) => function(e3, t3, n3 = Z) {
    ...
    if (e3.code == z || e3.code == Q) {
      ...
      for (let t4 = 0; t4 < i2.length; t4++) if (i2[t4] === o3) {
        if (e3.code == z) return r3(i2, t4, 0, -1);
        if (e3.code == Q) return r3(i2, t4, i2.length - 1, 1);
      }
    }
    return false;
...
async function ne(t2, r2, o2) {
  if (te = Object.assign(te, { debug: e(o2) }, t2), 0 === r2.querySelectorAll(a).length) return void n("info", "URL '" + o2.pathname + "' isn't marked-up for references, so skipped");
...
`;
      ...
      for (const r3 in e3) {
        ...
        "unknown" === e3[r3].auth && (l3 = t3[0]), l3.length > te.maxAuthLen && (l3 = l3.substring(0, te.maxAuthLen)), n2.push({ auth: l3, date: o3, desc: s3, offset: parseInt(r3, 10), title: a2, url: e3[r3].url });
      }
      return n2;
    }(l2.body));
    !function(e3, t3) {
...
function ie(e2, t2) {
  const n2 = new RegExp("`([^`]+)`", "g"), r2 = new RegExp("/ /", "g");
  e2.nodeType === Node.TEXT_NODE && "CODE" !== !t2.tagName && (t2.innerHTML = t2.innerHTML.replaceAll(n2, '<code class="bashSample" title="Quote from a bash; will add copy button">$1</code>').replaceAll(r2, "//"));
}
function ae(e2, t2) {
  let n2 = 0;
...
await async function(t2, r2, o2, i2) {
  ...
  ue.pageInitRun = 1;
  const c2 = Array.from(r2.querySelectorAll(".noJS"));
  ...
  !function(e2, t3) {
    ...
    for (const e2 in s2) {
      ...
      l2 && c3.removeChild(s2[e2]), t4.classList.remove("bigScreenOnly"), i3.push("<li>"), i3.push(t4.outerHTML), i3.push("</li>"), s2[e2].getAttribute("id") && s2[e2].setAttribute("id", "old" + s2[e2].getAttribute("id"));
    }
  ...
  if (oe(u2, r2, i2), function(e2, t3, n2) {
    ...
    if (r3.length > 0) for (let e3 = 0; e3 < r3.length; e3++) 0 === r3[e3].querySelectorAll("code").length ? r3[e3].innerHTML = r3[e3].innerHTML.replaceAll(t3, '<code class="bashSample" title="Quote from a bash; will add copy button">$1</code>').replaceAll(n2, "//") : x(r3[e3], ie);
  }(r2), function(e2) {
    const t3 = M.get(l, e2);
    if (!t3) return;
    ...
    C("body, .annoyingBody { font-family: " + n2.ft + "; font-size: " + n2.fs + "; direction:" + n2.dn + "; }", "client-set-css", e2);
  }(r2), ce(r2), R(1040, r2, o2, i2), L(r2, i2.navigator, i2) && function(e2, t3) {
    ...
    const i3 = Object.assign({}, { timeFormat: "m", dataLocation: ".blocker", target: "#shareGroup .SMshareWidget", wordPerMin: 275, codeSelector: "code", refresh: false, debug: e(o3) }, t3), a3 = i3.dataLocation + " img, " + i3.dataLocation + " source, " + i3.dataLocation + " object", s2 = ae(i3.dataLocation, r3);
    if (!s2) return;
    let l2 = 0;
    i3.codeSelector && (l2 += ae(i3.codeSelector, r3));
    let c3 = s2 - l2 + 2 * l2;
    if (c3 += 5 * Array.from(new Set(Array.from(r3.querySelectorAll(a3)).map(se))).length, c3 = Math.ceil(c3 / i3.wordPerMin), c3 < 1) return void n("info", "No reading time displayed for this article");
    if (i3.refresh) {
      const e2 = r3.querySelector(i3.target + " a.reading");
      e2 && e2.parentNode.removeChild(e2);
    }
    c3 = Math.round(c3);
    const u3 = '<a class="reading" title="The text is ' + (l2 + s2) + ' normalised words long.  Link is a longer version of this reading guide guesstimate." href="/resource/text-reading-duration">To read: ' + c3 + i3.timeFormat + "</a>";
    w(i3.target, u3, r3);
  }({ dataLocation: "#main", target: ".addReading .SMshareWidget", debug: a2, refresh: true }, r2, o2), ee(void 0, r2, o2), o2.pathname.match("group-")) {
    ...
    e2 && await H({ group: e2, debug: a2, runFetch: "adjacentRunFetch" in ue ? ue.adjacentRunFetch : X }, r2, o2, i2);
  } else {
    k(r2, o2, i2) ? await ne({ debug: a2, renumber: 1, runFetch: "mobileRunFetch" in ue ? ue.mobileRunFetch : X }, r2, o2) : function(e3) {
    ...
    else for (let t3 = 0; t3 < e2.length; t3++) await H({ group: e2[t3], debug: a2, iteration: t3, count: e2.length, runFetch: "adjacentRunFetch" in ue ? ue.adjacentRunFetch : X }, r2, o2, i2);
  }

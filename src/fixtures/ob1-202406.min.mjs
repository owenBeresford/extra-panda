...
const o = "1.0.4", i = "https://owenberesford.me.uk/", a = ".addReferences", s = a + " sup a", c = "appearance", l = 16, u = 180;
class d {
  set(e2, t2, n2) {
    let r2 = "";
    if (n2) {
...
function M(e2, t2, n2) {
  ...
  try {
    ...
    if (r2.has("mobile")) return A(r2.get("mobile") ?? "");
    let t3 = u;
    return k(e2, n2.navigator, n2) && (t3 = 1.11 * u), N(e2, n2) > t3;
  } catch (e3) {
...
let X = { name: "", meta: "", perRow: 10, titleLimit: 40, rendered: false, iteration: 0, group: "system", count: 1, debug: true, runFetch: p };
function U(e2, t2, n2, r2 = true) {
...
function D(e2, t2, n2, r2, o2) {
  return X.name === "group-" + X.group || (t2 === e2 && (o2 = r2), r2 > 0 && o2 > 0 && n2 > 0 && r2 >= n2 - 1 && (r2 = 0)), [o2, n2, r2];
}
async function F(t2, r2, o2, i2) {
  if (X = Object.assign(X, { name: m(o2), meta: U(X.group, ".json", o2, false), debug: e(o2), runFetch: p }, t2), "system" === X.group) throw new Error("Must set the article group, and not to 'system'.");
  X.meta = U(X.group, ".json", o2, false);
  const a2 = "group-XXX" === X.name || X.name === "group-" + X.group, s2 = "group" + X.group;
  if (M(r2, o2, i2) && !a2) 1 === r2.querySelectorAll(".adjacentWidget .adjacentItem").length && (r2.querySelector(".adjacentWidget p").style.display = "none"), E("#" + s2, "<p>As mobile View, use the full page link to the left</p>", r2);
  else {
    const e2 = await X.runFetch(X.meta, true, X.debug);
    if (!("ok" in e2) || !e2.ok || !Array.isArray(e2.body)) return n("info", "There doesn't seem to be a group meta data file."), void E("#" + s2, "<p>Internal error. Hopefully this will be fixed shortly. </p>", r2);
    if (a2) {
      const t3 = function(e3, t4, n2, r3, o3) {
        let i3 = "";
        for (const a3 in e3) {
          const s3 = j(a3, t4), c2 = M(n2, r3, o3) ? "<br />" : "";
          let l2 = e3[a3].desc;
          l2.length > 235 && (l2 = l2.substr(0, 235) + "..."), i3 += '<a class="adjacentItem" href="' + e3[a3].url + '" title="' + l2 + '"> <span class="button">' + e3[a3].title + '</span><p id="adjacent' + s3 + '" >Author: ' + e3[a3].auth + " &nbsp; &nbsp; &nbsp;" + c2 + "  Last edit: " + L(e3[a3].date, "Unknown time", true) + " <br />Description: " + l2 + " </p></a>\n";
        }
        return i3;
      }(e2.body, s2, r2, o2, i2);
      ...
      const t3 = function(e3) {
        let t4 = -1, n2 = X.perRow, r3 = [], o3 = 0, i3 = 0;
        for ([t4, n2, o3] = D(P(e3[0].url), X.name, e3.length, o3, t4); o3 < e3.length; o3++) {
          const a3 = e3[o3].title;
          if (a3 && t4 >= 0 && n2 > 0) {
            r3[i3] = { auth: e3[o3].auth, date: L(e3[o3].date, "[Unknown time]", true), url: e3[o3].url, offset: o3, title: e3[o3].title.substr(0, X.titleLimit), desc: e3[o3].desc }, a3.length > X.titleLimit && (r3[i3].title += "...");
            const t5 = e3[o3].desc;
            t5.length > 235 && (r3[i3].desc = t5.substr(0, 235) + "..."), n2--, i3++;
          }
          if ([t4, n2, o3] = D(P(e3[o3].url), X.name, n2, o3, t4), r3.length === e3.length) break;
          if (r3.length >= X.perRow) break;
        }
        return r3;
      }(e2.body);
      E("#" + s2, function(e3, t4) {
        ...
        for (const r3 in e3) {
          const o3 = j(r3, t4), i3 = I(e3[r3].desc.length > 110), a3 = "Title: " + e3[r3].title + "\nAuthor: " + e3[r3].auth + " &nbsp; &nbsp; Last edit: " + e3[r3].date + "\nDescription: " + e3[r3].desc;
...
function H(e2, t2, n2, r2) {
  if (!b(n2.host) && !M(t2, n2, r2)) return false;
...
function B(e2, t2, r2, o2) {
  ...
  if (a2 = "https://" + a2 + "/share?text=I+think+this+is+important+" + s2, n("info", "Trying to open mastodon server, " + a2), !R(o2)) throw Error("Test passed, for " + a2);
  return t2.querySelector("#popup").close(), o2.open(a2, "_blank"), M(t2, r2, o2) && H(0, t2, r2, o2), false;
}
function J(e2, t2, n2) {
  let r2 = e2.querySelector("#navBar #mastoTrigger");
  if (!r2) return;
  if (K(r2, $, e2, n2), r2 = e2.querySelector("#shareGroup .SMshareWidget #mastoTrigger"), r2) {
  ...
  }(r2, C, e2, t2, n2), _(e2.querySelector("#popup #sendMasto"), B, e2, t2, n2);
  const o2 = Array.from(e2.querySelectorAll("#shareMenuTrigger, #shareClose"));
  for (const r3 in o2) _(o2[r3], H, e2, t2, n2);
  K(e2.querySelector("#hideMasto"), G, e2, n2);
}
function $(e2, t2, n2) {
...
const Y = "Space", V = "ArrowLeft", z = "ArrowRight", Q = ".tab2Container";
function Z(e2 = Q, t2, r2) {
  if (t2.querySelector(e2) && (n("info", "Keybaord events enabled for " + e2, r2.hash), t2.addEventListener("keydown", (n2) => function(e3, t3, n3 = Q) {
    if (e3.code == Y) {
    ...
    if (e3.code == V || e3.code == z) {
      ...
      for (let t4 = 0; t4 < i2.length; t4++) if (i2[t4] === o3) {
        if (e3.code == V) return r3(i2, t4, 0, -1);
...
async function te(t2, r2, o2) {
  if (ee = Object.assign(ee, { debug: e(o2) }, t2), 0 === r2.querySelectorAll(a).length) return void n("info", "URL '" + o2.pathname + "' isn't marked-up for references, so skipped");
  const s2 = r2.querySelector("#biblio");
  s2 && s2.setAttribute("style", ""), r2.querySelector(ee.gainingElement + " *").replaceChildren(), E(ee.gainingElement, '<h2 class="biblioSection">References (for mobile UI)</h2> \n<p>The references embedded in the text are displayed here. </p>', r2);
  const c2 = await ee.runFetch(y(ee.referencesCache, o2), true, e(o2));
...
`;
      ...
      for (const r3 in e3) {
        ...
        const o3 = L(e3[r3].date, t3[2], true);
        let a2 = e3[r3].title + "";
        a2 = a2.replace(".", ".  ");
        let s3 = e3[r3].desc + "";
        s3.length > ee.maxDescripLen && (s3 = s3.substring(0, ee.maxDescripLen));
        let c3 = e3[r3].auth || t3[0];
        "unknown" === e3[r3].auth && (c3 = t3[0]), c3.length > ee.maxAuthLen && (c3 = c3.substring(0, ee.maxAuthLen)), n2.push({ auth: c3, date: o3, desc: s3, offset: parseInt(r3, 10), title: a2, url: e3[r3].url });
      }
      return n2;
    }(c2.body));
    !function(e3, t3) {
      if (!ee.renumber) return;
      const n2 = Array.from(t3.querySelectorAll(ee.losingElement + " sup a"));
      for (let e4 = 0; e4 < n2.length; e4++) n2[e4].textContent = "" + (e4 + 1), ee.forceToEnd && (n2[e4].href = "#biblio");
    }(c2.body, r2), E(ee.gainingElement, e2, r2);
  } else {
    const e2 = '<p class="error">Unable to get bibliographic data for this article.</p>';
    E(ee.gainingElement, e2, r2), n("warn", "Unable to get meta data " + y(ee.referencesCache, o2), JSON.stringify(Array.from(c2.headers.entries())));
  }
}
function ne(e2, t2) {
  if (null === e2) return;
  ...
  const a2 = Math.round(T(o2, "left", t2)), s2 = Math.round(T(o2, "top", t2)), c2 = Math.round(T(o2, "width", t2)), u2 = 30 * l, d2 = 5 * l;
...
function re(e2, t2, n2) {
  t2.querySelectorAll("article a").forEach(function(r2) {
    "git" === g(r2).trim().toLowerCase() && (r2.textContent = "", E(r2, '<i class="fa fa-github" aria-hidden="true"></i><span class="sr-only">git</span>', t2), e2 ? (r2.setAttribute("aria-label", function(e3) {
      const t3 = new URL(e3);
      let n3 = "[anon dev]", r3 = "";
    ...
    }(r2.getAttribute("href"))), ne(r2, n2)) : r2.setAttribute("title", "Link to a github project."));
  });
}
function oe(e2, t2) {
  let n2 = 0;
...
let ce = { pageInitRun: 0 };
function le() {
  return ce.pageInitRun;
}
function ue(e2, t2, n2) {
  const r2 = n2.querySelector(t2);
  r2.addEventListener("mousedown", () => de(t2, e2), { capture: true, passive: true }), r2.addEventListener("touchstart", () => de(t2, e2), { capture: true, passive: true });
}
function de(e2, t2, n2 = "fullScreen") {
...
await async function(t2, r2, o2, i2) {
  ce = Object.assign(ce, {}, t2);
  const a2 = e(o2);
  if (ce.pageInitRun) return void n("warn", "Extra panda should not be run more than once per page");
  ce.pageInitRun = 1;
  ...
  !function(e2, t3) {
    ...
    const o3 = M(t3, n2, r3);
    if (!b(n2.host) && !o3) return;
    if (k(t3, r3.navigator, r3) && !o3) return;
    o3 && (t3.querySelector("#sendMasto").textContent = "Share article");
    const i3 = ['<li id="shareClose"> <i class="fa fa-cancel" aria-hidden="true"></i> </li>	<li> <a class="hunchUp" id="copyURL"><i class="fa fa-copy" aria-hidden="true"></i><span class="hunchUp"> copy<br /> URL</span> </a> </li>'], a3 = ["shareMenuTrigger", "siteChartLink", "rssLink"], s2 = Array.from(t3.querySelectorAll(".SMshareWidget a")), c2 = !b(n2.host) && !e(n2), l3 = t3.querySelector(".SMshareWidget");
    for (const e2 in s2) {
      if (a3.includes(s2[e2].id)) continue;
      const t4 = s2[e2].cloneNode(true);
      c2 && l3.removeChild(s2[e2]), t4.classList.remove("bigScreenOnly"), i3.push("<li>"), i3.push(t4.outerHTML), i3.push("</li>"), s2[e2].getAttribute("id") && s2[e2].setAttribute("id", "old" + s2[e2].getAttribute("id"));
    }
    i3.unshift('<nav class="mobilePopupWidget" id="mobileMenu"> <menu>'), i3.push("</menu></nav>"), E("#navBar", i3.join("\n"), t3);
  }(r2, o2, i2), J(r2, o2, i2);
  const u2 = null !== r2.querySelector(".addReferences");
  if (re(u2, r2, i2), function(e2, t3, n2) {
    t3.querySelectorAll("article a").forEach(function(r3) {
      "docs" === g(r3).trim().toLowerCase() && (r3.textContent = "", E(r3, '<i class="fa fa-book-open" aria-hidden="true"></i><span class="sr-only">docs</span>', t3), r3.setAttribute(e2 ? "aria-label" : "title", "Link to the project docs; it may be a git page, or a separate webpage. "), e2 && ne(r3, n2));
    });
  }(u2, r2, i2), function(e2) {
    const t3 = Array.from(e2.querySelectorAll(".addArrow"));
    for (let n2 = 0; n2 < t3.length; n2++) E(t3[n2].parentElement, '<i class="fa fa-play specialPointer" aria-hidden="true"></i>', e2);
  }(r2), function(e2) {
  ...
  }(r2), se(r2), x(1040, r2, o2, i2), k(r2, i2.navigator, i2) && function(e2, t3) {
    ...
    const i3 = Object.assign({}, { timeFormat: "m", dataLocation: ".blocker", target: "#shareGroup .SMshareWidget", wordPerMin: 275, codeSelector: "code", refresh: false, debug: e(o3) }, t3), a3 = i3.dataLocation + " img, " + i3.dataLocation + " source, " + i3.dataLocation + " object", s2 = oe(i3.dataLocation, r3);
    if (!s2) return;
    let c2 = 0;
    i3.codeSelector && (c2 += oe(i3.codeSelector, r3));
    let l3 = s2 - c2 + 2 * c2;
    if (l3 += 5 * Array.from(new Set(Array.from(r3.querySelectorAll(a3)).map(ie))).length, l3 = Math.ceil(l3 / i3.wordPerMin), l3 < 1) return void n("info", "No reading time displayed for this article");
    if (i3.refresh) {
      const e2 = r3.querySelector(i3.target + " a.reading");
      e2 && e2.parentNode.removeChild(e2);
    }
    l3 = Math.round(l3);
    const u3 = '<a class="reading" title="The text is ' + (c2 + s2) + ' normalised words long.  Link is a longer version of this reading guide guesstimate." href="/resource/text-reading-duration">To read: ' + l3 + i3.timeFormat + "</a>";
    E(i3.target, u3, r3);
    ...
    e2 && await F({ group: e2, debug: a2, runFetch: "adjacentRunFetch" in ce ? ce.adjacentRunFetch : p }, r2, o2, i2);
  } else {
    ...
    else for (let t3 = 0; t3 < e2.length; t3++) await F({ group: e2[t3], debug: a2, iteration: t3, count: e2.length, runFetch: "adjacentRunFetch" in ce ? ce.adjacentRunFetch : p }, r2, o2, i2);
  }
  e(o2, "select") && (n("info", "select and word count feature is ENABLED.  Access= <alt> + w"), r2.body.addEventListener("keydown", (e2) => {
    "w" === e2.key && e2.altKey && n("info", "Word count of selection: " + w(function(e3) {
      try {
        const t3 = e3.getSelection();
        if (null === t3 || 0 === t3.rangeCount) return n("warn", "no selection object found "), "";
        const r3 = t3.getRangeAt(0);
        return r3.startOffset === r3.endOffset ? (n("warn", "no selection volume found "), "") : "" + r3.cloneContents().textContent;
      } catch (e4) {

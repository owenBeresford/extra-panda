...
.
If you see any security errors please [raise a fault in github](https://github.com/owenBeresford/extra-panda/issues)
.
...
- Nothing new learned in these links: 
   - [Aptori](https://aptori.dev/blog/javascript-security-a-secure-coding-checklist-for-developers)
   - [Raygun](https://raygun.com/blog/js-security-vulnerabilities-best-practices/)
